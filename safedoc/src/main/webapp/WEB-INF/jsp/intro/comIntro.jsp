		...
		<div class="page-box-content">
			...
			<div class="container">
				<div class="row">
					...
					<ul>
						<li>총인원 : 25명(관리 4명, 구조물진단 15명, 구조설계 : 4명, 토질 및 기초 1명)
							건축구조/토목구조/시공/안전관리/토질 및 기초분야의 기술사 전문가 그룹</li>
						<li>사무실 면적 : 35평</li>
						<li>보유장서 : 3,500여권</li>
						<li>업무지원장비 및 프로그램 : 진단계측장비 및 구조해석프로그램(Plotter, 초음파탐상기,
							진동소음측정장비, 흙막이계측장비, 동적특성측정기외 25종/Auto CAD, uniARCH, 구조해석 프로그램
							MIDAS, SAP 2000 외)</li>
					</ul>
					</article>
				</div>
